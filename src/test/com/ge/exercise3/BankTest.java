...
public class BankTest {
    ...
    @Test
    public void overdrawFromCurrentAccountTest() {
        Account account = new Account("005", "Checking", 200.0f);
        bank.addAccount(account);
        bank.withdrawFromAccount("005", 105.0f);
        assertEquals(200.0f, account.getBalance(), 0.01);
    }
    
    @Test
    public void negativeBalanceTest() {
        Account account = new Account("006", "Savings", 200.0f);
        bank.addAccount(account);
        bank.withdrawFromAccount("006", 300.0f);
        assertEquals(200.0f, account.getBalance(), 0.01);
    }
}