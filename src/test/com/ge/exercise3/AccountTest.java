...
public class AccountTest {
    ...
    {
    	savingsAccount = new Account("010", "Savings", 10.0f);
    	assertEquals("Profit", savingsAccount.projection());
    	checkingAccount = new Account("011", "Checking", 5.0f);
    	checkingAccount.setMonthlyFee(7);
    	assertEquals("Loss", checkingAccount.projection());
